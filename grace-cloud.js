...
style.textContent = `
  ...
  @media(max-width:760px){.score-shell.show,.score-shell:target{display:block}.score-sidebar{height:100%;box-sizing:border-box;border:0}.score-viewer{position:fixed;z-index:2;inset:0;display:none}.score-viewer.show{display:flex}}
`;
